...
export const STRATEGY_META: Record<string, StrategyMeta> = {
  ...
  settlement_betting: {
    displayName: 'Settlement Betting',
    shortName: 'Settlement',
    description: 'Buys cheap YES contracts near expiry, betting on settlement at 100. Not actual market making.',
    edgeType: 'Settlement',
    category: 'crypto',
    expectedWinRate: 0.15,
    howItWorks: 'Identifies contracts trading at low prices near expiry and buys YES positions, hoping the underlying settles in-the-money for a 100c payout. Risk is total loss of premium if settlement goes against.',
    riskProfile: 'aggressive',
    configSchema: [
      ...UNIVERSAL_FIELDS,
  ...
  market_making: {
    displayName: 'Market Making (Legacy)',
    shortName: 'Market Maker',
    description: 'Legacy name for settlement betting strategy. Kept for historical data rendering.',
    edgeType: 'Settlement',
    category: 'crypto',
    expectedWinRate: 0.15,
    howItWorks: 'See settlement_betting. This entry exists to render historical trades that used the old name.',
    riskProfile: 'aggressive',
    configSchema: [
      ...UNIVERSAL_FIELDS,
      { key: 'min_spread_cents', label: 'Min Spread', type: 'number', suffix: 'c', min: 1, max: 10, step: 1 },
